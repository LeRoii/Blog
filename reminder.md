...
* 左值：<br>
非临时对象，可以持久存在的，**可以取地址**的值，那些可以在多条语句中使用的对象。所有的变量都满足这个定义，在多条代码中都可以使用，都是左值

* 右值：<br>
临时对象，立即数，只在当前语句中有效，**无法取址**
...
```
将指针指向临时对象的内存，临时对象的指针置空，这样临时对象在销毁时就不会有数据的内存

[ref1](http://blog.csdn.net/tiandyoin/article/details/43603615)<br>
[ref2](http://blog.csdn.net/yapian8/article/details/42341307)<br>
